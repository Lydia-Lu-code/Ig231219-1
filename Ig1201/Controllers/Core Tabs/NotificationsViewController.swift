...
//        noNotificationsView.center = view.center
        ...
        for x in 0...100 {
            ...
            let model = UserNotification(type: x % 2 == 0 ? .like(post: post) : .follow,
                                         ...
                                         user: User(username: "Lydia",
                                                    ...
                                                    birthDate: Date(),
                                                    gender: .male,
                                                    counts: UserCount(followers: 1, follewing: 1, posts: 1),
                                                    joinDate: Date()))
            models.append(model)
        }
    }
    ...
    private func addNoNotificationsView() {
        ...
        view.addSubview(tableView)
//        noNotificationsView.frame = CGRect(x: 0, y: 0, width: view.bounds.width / 2, height: view.bounds.width/4)
...
extension NotificationsViewController: NotificationLinkEventTableViewCellDelegate {

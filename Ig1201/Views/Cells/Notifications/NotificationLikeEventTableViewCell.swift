...
//  Ig1201
//
//  Created by 維衣 on 2023/12/6.
//
import SDWebImage
import UIKit

protocol NotificationLinkEventTableViewCellDelegate: AnyObject {
    func didTapRelatedPostButton(model: UserNotification)
}

class NotificationLikeEventTableViewCell: UITableViewCell {

    static let identifier = "NotificationLinkEventTableViewCell"
    
    weak var delegate: NotificationLinkEventTableViewCellDelegate?
    ...
    private let label: UILabel = {
        ...
        label.text = "@Lydia liked your photo."
        return label
    }()
